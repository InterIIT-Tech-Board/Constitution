...
\begin{enumerate}
    ...
    \item In the event that any public online repository containing content identical or substantially similar to the final submission links a particular IIT to a specific problem statement prior to the official declaration of results, a 100\% penalty shall be levied on the points allocated to that stage of the event.
\end{enumerate}
