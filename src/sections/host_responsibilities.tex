...
\paragraph{}
Manage the transition process upon the finalization of the Host IIT for the next InterIIT Tech Meet, adhering to the following timelines:
\begin{enumerate}
    \item If the Host IIT is finalized before the end of the summer break (i.e., prior to the start of the next odd semester following the InterIIT Tech Meet), the transfer of social media credentials, website/domain access, and digital assets, along with the official announcement on all social media platforms, shall occur after the conclusion of the summer break.
    \item If the Host IIT is finalized after the summer break, the transfer of all credentials and digital assets, as well as the official announcement on all InterIIT Tech Meet social media platforms, shall be executed immediately upon host finalization.
